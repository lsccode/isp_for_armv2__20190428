...
#define FSM_NAMES {"GENERIC","USER2KERNEL","SENSOR","CMOS","GENERAL","AE_ACAMERA","AWB_ACAMERA","COLOR_MATRIX","IRIDIX_ACAMERA","MATRIX_YUV","GAMMA_ACAMERA","AF_ACAMERA","MONITOR","SHARPENING"}
