...
#elif defined( ISP_HAS_AWB_ACAMERA_FSM )
...
#elif defined( ISP_HAS_AF_ACAMERA_FSM )
...
#if defined( ISP_HAS_GAMMA_CONTRAST_FSM ) || defined( ISP_HAS_GAMMA_MANUAL_FSM ) || defined( ISP_HAS_GAMMA_ACAMERA_FSM )
...
#if defined( ISP_HAS_IRIDIX_HIST_FSM ) || defined( ISP_HAS_IRIDIX8_FSM ) || defined( ISP_HAS_IRIDIX_MANUAL_FSM ) || defined( ISP_HAS_IRIDIX8_MANUAL_FSM ) || defined( ISP_HAS_IRIDIX_ACAMERA_FSM )
