...
#if defined( ISP_HAS_AWB_MESH_NBP_FSM ) || defined( ISP_HAS_AWB_MANUAL_FSM ) || defined( ISP_HAS_AWB_ACAMERA_FSM )
...
// Tuning params
    ...
    md->sharpening_directional = acamera_isp_demosaic_rgb_sharp_alt_ld_read( isp_base );
    md->sharpening_unidirectional = acamera_isp_demosaic_rgb_sharp_alt_lu_read( isp_base );
...
{
    const char *modes[WDR_MODE_COUNT] = {"Linear", "Native HDR", "FS Linear"};
